...
export const trainingLevels: TrainingLevel[] = [
  ...
  },
  {
    ...
    questions: [
      {
        id: 'response-listen-1',
        prompt: '听回应，选择林克的反应。',
        audioText: 'Sounds good.',
        sentence: 'Sounds good. · 听上去不错。',
        options: [
          { id: 'accept', label: '林克开心手舞足蹈' },
          { id: 'refuse', label: '林克遗憾大哭' },
        ],
        correctOptionId: 'accept',
      },
      {
        id: 'response-listen-2',
        prompt: '再听一次，选择林克的反应。',
        audioText: "Sorry, I can't.",
        sentence: "Sorry, I can't. · 不好意思，我不能去。",
        options: [
          { id: 'accept', label: '林克开心手舞足蹈' },
          { id: 'refuse', label: '林克遗憾大哭' },
        ],
    ...
    feedback: '对！你听懂了朋友的回应。',
    completion: '完成 4 轮听回应练习。',
    skillKeys: ['response-understanding'],
  },
  {
    id: 'level-15-closing',
    ...
    questions: [
      {
        ...
        sentence: 'Do you want to go swimming this Saturday?',
        correctOptionId: 'accept',
        closingAnswer: 'Great! See you then.',
      },
      {
        id: 'relay-refuse-1',
        prompt: '听回应，完成这段对话接力。',
        audioText: "Sorry, I can't.",
        sentence: 'Do you want to go shopping this Sunday?',
        correctOptionId: 'refuse',
        closingAnswer: 'No problem.',
      },
      {
        id: 'relay-accept-2',
        prompt: '再来一轮对话接力。',
        audioText: 'Sounds good.',
        sentence: 'Do you want to play basketball tomorrow?',
        correctOptionId: 'accept',
        closingAnswer: 'Great! See you then.',
      },
      {
        ...
        prompt: '最后一轮，完成对话接力。',
        audioText: "Sorry, I can't.",
        sentence: 'Do you want to watch a movie this Saturday?',
        correctOptionId: 'refuse',
        closingAnswer: 'No problem.',
      },
    ],
