...
export const trainingLevels: TrainingLevel[] = [
  ...
  },
  {
    ...
    questions: [
      {
        id: 'l12-q1',
        prompt: '图片：泳池图。时间：this Saturday。',
        options: [
          { id: 'A', label: 'Do you want to go swimming this Saturday?' },
          { id: 'B', label: 'Do you want to go shopping this Sunday?' },
        ],
        correctOptionId: 'A',
      },
      {
        id: 'l12-q2',
        prompt: '图片：商店图。时间：tomorrow。',
        options: [
          { id: 'A', label: 'Do you want to go shopping tomorrow?' },
          { id: 'B', label: 'Do you want to watch a movie this Saturday?' },
        ],
        correctOptionId: 'A',
      },
      {
        id: 'l12-q3',
        prompt: '图片：游戏手柄图。时间：this Sunday。',
        options: [
          { id: 'A', label: 'Do you want to play basketball this Sunday?' },
          { id: 'B', label: 'Do you want to play video games this Sunday?' },
        ],
        correctOptionId: 'B',
      },
      {
        id: 'l12-q4',
        prompt: '图片：电影院图。时间：tomorrow。',
        options: [
          { id: 'A', label: 'Do you want to watch a movie tomorrow?' },
          { id: 'B', label: 'Do you want to go swimming tomorrow?' },
        ],
        correctOptionId: 'A',
      },
    ],
    feedback: '很好！提示变少后你也能迁移使用邀请句。',
    completion: '完成 4 道迁移题。',
    skillKeys: ['invitation-pattern', 'activity-chunks', 'time-expressions'],
  },
  {
